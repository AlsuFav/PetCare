...
import ru.fav.petcare.pet.add.databinding.FragmentAddPetBinding
import ru.fav.petcare.pet.add.R
...
class AddPetFragment: Fragment(R.layout.fragment_add_pet) {
    ...
    private fun initViews() = with(viewBinding) {
        ...
        this.buttonAddPet.setOnClickListener {
            ...
            val species = if (isDogSelected) getString(ru.fav.petcare.presentation.R.string.dog) else getString(ru.fav.petcare.presentation.R.string.cat)
